  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0c08] px-4 py-12 text-[#E8E9E3] selection:bg-[#D2FF00] selection:text-black font-['Space_Grotesk']">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-1/3 -left-20 h-[500px] w-[500px] rounded-full bg-[#D2FF00]/10 blur-[150px] animate-[blobMove_10s_ease-in-out_infinite_alternate]" />
        <div className="absolute bottom-1/3 -right-20 h-[450px] w-[450px] rounded-full bg-[#00F0FF]/10 blur-[140px] animate-[blobMove_8s_ease-in-out_infinite_alternate-reverse]" />
      ...
      <main className="w-full max-w-md">
        <div className="group relative rounded-[28px] border border-white/[0.08] bg-white/[0.02] p-8 text-center backdrop-blur-2xl transition-all duration-500 hover:border-[#D2FF00]/30 hover:bg-white/[0.03] shadow-[0_20px_50px_rgba(0,0,0,0.6)] sm:p-10">
          
          <Link
            href="/"
            className="group/logo inline-block font-['Syne'] text-2xl font-extrabold tracking-tight text-white focus-visible:outline-none mb-4"
          >
          ...
          <h1 className="font-['Syne'] text-xl font-bold tracking-tight text-white cursor-default select-none transition-all duration-300 hover:scale-[1.01] text-glow-hover sm:text-2xl mb-6">
            Verifikasi Email
          </h1>

          <div
            role="alert"
            className={`mb-8 rounded-2xl border p-4 text-center text-xs font-semibold backdrop-blur-xl transition-all duration-300 ${
              isError
          ...
          <Link
            href="/login"
            className="inline-block w-full rounded-full bg-[#D2FF00] py-4 text-[12px] font-bold tracking-[0.15em] uppercase text-black shadow-[0_0_20px_rgba(210,255,0,0.3)] transition-all duration-300 hover:bg-[#e0ff4d] hover:shadow-[0_0_30px_rgba(210,255,0,0.6)] active:scale-[0.98]"
          >
            Ke Halaman Login
          </Link>
        </div>
